...
public class StudentController {
    ...
    public String studentAdd(HttpServletRequest request) {
        ...
        String educationalInstitution = request.getParameter("educationalInstitution");
        String password = request.getParameter("password");
        String age = request.getParameter("age");
        
        if (name != null && email != null && educationalInstitution != null && password != null && age != null)
            studentDao.persist(new Student(name, email, educationalInstitution, Integer.valueOf(age), password));
